...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **yes. But they cannot be used and applied everywhere.**

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**Apply clean coding principles to own code first. Then refactor legacy code with confidence, but only where it is necessary. It is all about balance in code.**
